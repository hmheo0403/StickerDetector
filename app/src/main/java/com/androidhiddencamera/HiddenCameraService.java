...
public abstract class HiddenCameraService extends Service implements CameraCallbacks {
    ...
    protected void startCamera(CameraConfig cameraConfig) {
        Toast.makeText(this, "HAHA HiddenCameraService startCamera()", Toast.LENGTH_LONG).show();
        if (!HiddenCameraUtils.canOverDrawOtherApps(this)) {    //Check if the draw over other app permission is available.
            Toast.makeText(this, "HAHA HiddenCameraService startCamera() ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(this, "HAHA HiddenCameraService startCamera() ERROR_DOES_NOT_HAVE_FRONT_CAMERA", Toast.LENGTH_LONG).show();
    ...
    private CameraPreview addPreView() {
        Toast.makeText(this, "HAHA HiddenCameraService addpreview() ", Toast.LENGTH_LONG).show();
